    ...
    def _resize_img(self, results):
        ...
        for key in results.get('img_fields', ['img']):
            if self.keep_ratio:
                ...
                # if new_h % 14 != 0 or new_w.shape % 14 != 0:
                #     import pdb;pdb.set_trace()
                ...
                img, w_scale, h_scale = mmcv.imresize(
                    ...
                    interpolation=self.interpolation,
                    backend=self.backend)
                # if img.shape[0] % 14 != 0 or img.shape[1] % 14 != 0:
                #     import pdb;pdb.set_trace()
            results[key] = img
...
# @PIPELINES.register_module()
# class Resize_dinov2(MMCV_Resize):
...
class RandomChoiceResize:
    ...
    def __init__(
        self,
        scales: Union[int, Tuple[int, int]],
        ...
        **resize_kwargs,
        ...
        self.resize = PIPELINES.build({'scale': 0, **self.resize_cfg})
...
class ResizeShortestEdge:
    ...
    def __init__(self,
        ...
        self.resize_cfg = dict(type=resize_type, **resize_kwargs)
        self.resize = PIPELINES.build({'img_scale': 0, **self.resize_cfg})
